...
export default function Login() {
  ...
  const { connect, disconnect, user, setUser } = useContext(MonContext);
  ...
  async function getUser(emailCheck, passwordCheck) {
    ...
    const matchingUser = users.find((user) => {
      return user.email == emailCheck && user.password == passwordCheck;
    });
    console.log("Matching user" + matchingUser.username);
    return matchingUser;
  }
  ...
  async function handleLogin() {
    if (email !== "" && password !== "") {
      ...
      const matchingUser = await getUser(emailCheck, passwordCheck);
      ...
      if (matchingUser) {
        ...
        alert("Email incorrect ou mot de passe incorrect");
      }
    }
  }
