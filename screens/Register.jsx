          ...
          if (chechPhone(tel)) {
            if (passwordCheck !== "") {
              if (passwordCheck.length >= 8) {
                ...
                // faire un check ici dans le storage pour check si il existe pas déjà
                // si existe deja mettre userexist à true
